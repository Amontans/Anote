...
- **v1.7 模块化收官 + v1.8 P0 备份恢复**：services 15 领域（+literature/migration/index/zotero/papers）；backup-create/restore/archive 三命令；周日自动加密冷备
