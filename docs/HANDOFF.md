...
- **v1.9.1 文档阅读补全**：anote read/ebook/index-pdf；epub 提取（stdlib）；PDF 文本可检索（cwd=root rg 修复）；mobi 需 calibre（未装，可 sudo pacman -S calibre）
