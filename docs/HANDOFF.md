...
- **v1.6 完成**：anote graph（图谱）+ anote report（周报）+ TUI 主题系统 + anote help <cmd> + 模块化重构（services/ 包：queue/notes/stats/bib）+ PROCESS.md 六步流程 + anote release
